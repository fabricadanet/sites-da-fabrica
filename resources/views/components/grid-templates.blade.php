...
<div class="min-h-screen flex flex-col">
    ...
    <div class="max-w-7xl mx-auto py-8 px-4">
      <div class="text-center text-gray-600 dark:text-gray-400">
        <p class="text-lg mb-2">
          © 2025 <strong>SaaS Templates</strong> — desenvolvido com 💜
        </p>
        <p class="text-sm">
  ...
  <script>
    const templates = [
      ...
      { id: 11, nome: "Silva & Advogados", arquivo: "template-advogados1.html", json: "dados-advogados1.json", nicho: "advocacia", descricao: "Escritório tradicional com áreas de atuação" },
      ...
      // EVENTOS (2 templates)
      { id: 13, nome: "Festas Perfeitas", arquivo: "template-eventos1.html", json: "dados-eventos1.json", nicho: "eventos", descricao: "Festas e celebrações completas" },
      { id: 14, nome: "Prime Events", arquivo: "template-eventos2.html", json: "dados-eventos2.json", nicho: "eventos", descricao: "Eventos corporativos de alto padrão" },

      // MÉDICO (2 templates)
      { id: 15, nome: "Clínica Vida & Saúde", arquivo: "template-medico1.html", json: "dados-medico1.json", nicho: "medico", descricao: "Clínica multiespecializada completa" },
      { id: 16, nome: "Espaço Saúde Integral", arquivo: "template-medico2.html", json: "dados-medico2.json", nicho: "medico", descricao: "Centro médico com telemedicina" },
      ...
      // mais um advogado
      { id: 19, nome: "Silva & Advogados", arquivo: "template-advogados3.html", json: "dados-advogados3.json", nicho: "advocacia", descricao: "Escritório tradicional com áreas de atuação" },
      //site institucional multipaginas
      { id: 20, nome: "Institucional MultiPáginas", arquivo: "./template-institucional/index.html", json: "./template-institucional/config.json", nicho: "geral", descricao: "Site institucional com múltiplas páginas e navegação aprimorada" },
    ];
